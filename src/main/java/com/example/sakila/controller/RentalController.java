...
public class RentalController {
	...
	public String addRental(Rental rental) {
		...
		return "redirect:/on/customerOne?customerId="+rental.getCustomerId(); // 이 값은 받는 정보에 따라 변경될수있음.
		// 오후 숙제 : customerOne = 고객 개인정보 : customer X address || Rental X Film
		// RentalListByCustomerId"
	}
}